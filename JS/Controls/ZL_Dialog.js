...
ZL_Dialog.prototype = {
    ShowModal: function (_url,_title) {
        ...
        var header =  "<button type='button' class='close' data-dismiss='modal'><i class='fa fa-close sys_close_bnt' aria-hidden='true'></i></button>@Opion";
        ...
        if (ref.ajaxurl && ref.ajaxurl != "") {//ajax加载
            ...
            Opion = ref.maxbtn ? "<button type='button' id='BigOpion' title='全屏' class='close sys_Fullscreen_btn'><i class='fa fa-arrows-alt'></i></button>" : "";
